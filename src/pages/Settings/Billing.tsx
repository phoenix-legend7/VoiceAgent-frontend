      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 items-start justify-center gap-6">
        <div className="bg-gray-900 rounded-md px-8 py-4">
            ...
            <div className="w-1/2 flex items-center rounded overflow-hidden border border-gray-700 select-none">
              <div
                className={clsx(
                  ...
                  refillAmount === 500
                    ? "bg-sky-600/20 text-sky-600 hover:text-sky-400 hover:bg-sky-700/50 border-sky-900"
                    : "bg-gray-600/20 border-gray-700 text-gray-400 hover:text-gray-300 hover:bg-gray-700"
                )}
              ...
              <div
                className={clsx(
                  ...
                  refillAmount === 10000
                    ? "bg-sky-600/20 text-sky-600 hover:text-sky-400 hover:bg-sky-700/50"
                    : "bg-gray-600/20 text-gray-400 hover:text-gray-300 hover:bg-gray-700"
                )}
          ...
          <div className="my-3 flex gap-3 w-full items-center">
            ...
            <div>
              {userData.auto_refill.enabled ? (
                ...
                <StatusBadge
                  colors="border-red-400 bg-red-800/20 text-red-400"
                  status="Inactive"
                />
              )}
            </div>
          ...
          <div className="my-3 flex gap-3 w-full items-center justify-end">
            <div className="flex items-center gap-3">
              ...
              {userData.auto_refill.enabled && (
                <button className="bg-red-800 px-4 py-2 rounded-md cursor-pointer hover:bg-red-600/80 transition-all duration-300">
                  Remove
                </button>
              )}
            </div>
        ...
        >
          ...
          <div className="space-y-4 p-6">
            ...
            <div className="pt-2">
              <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-slate-700 text-slate-400">
                Powered by stripe
              </div>
            </div>
          </div>
