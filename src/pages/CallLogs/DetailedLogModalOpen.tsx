  ...
  return (
    <div className="mt-5">
      <div className="flex gap-2 items-center">
        Agent Config
        <button
          className="cursor-pointer rounded-md border border-sky-500 px-2 py-1 text-sm text-sky-500 hover:border-sky-700 dark:hover:border-sky-300 hover:text-sky-700 dark:hover:text-sky-300 select-none transition-all duration-300"
      ...
      <div className={clsx(
        "whitespace-pre text-sm bg-gray-200 dark:bg-gray-800 rounded-lg mt-2 transition-all duration-300",
    ...
    >
      {!!selectedLog && (
        <div>
                ...
                <div className="flex flex-wrap items-center gap-4">
                  {selectedLog.cost_breakdown.map((cost, index) => (
                    <div className="flex items-center gap-2" key={index}>
                      <div className="text-sm rounded bg-gray-200 dark:bg-gray-800 px-2 py-0.5">
                        {cost.type}
                      </div>
                      <div className="text-gray-600 dark:text-gray-400">
          ...
          <hr className="text-gray-300 dark:text-gray-700 mb-2" />
          {!!selectedLog.chat && (JSON.parse(selectedLog.chat) as ChatType[]).map((chat, index) => (
            <div key={`chat${index}`} className="flex items-start gap-3 my-1.5">
              <div className="p-2 mt-1 bg-gray-200 dark:bg-gray-800 rounded-md">
              ...
              <div className="flex flex-col w-[calc(100%-0.75rem-40px)]">
                ...
                {!!chat.tool_calls && (
                  <div className="text-gray-600 dark:text-gray-400 text-xs rounded bg-gray-200 dark:bg-gray-800 px-2 py-1 mt-2 overflow-hidden">
                    <div>Tool Calls:</div>
